...
default: test_ntt test_addition test_mult
...
polyveck_addition.o: polyvec.c polyvec.h params.h Makefile
	$(CC) $(CFLAGS) -DADDITION_PROOF -DPOLYVEC_TYPE=polyveck -DPOLYVEC_LENGTH=K -c $< -o $@

polyvecl_addition.o: polyvec.c polyvec.h params.h Makefile
...
polyveck_mult.o: polyvec.c polyvec.h params.h Makefile
	$(CC) $(CFLAGS) -DMULTIPLICATION_PROOF -DPOLYVEC_TYPE=polyveck -DPOLYVEC_LENGTH=K -c $< -o $@

polyvecl_mult.o: polyvec.c polyvec.h params.h Makefile
	$(CC) $(CFLAGS) -DMULTIPLICATION_PROOF -DPOLYVEC_TYPE=polyvecl -DPOLYVEC_LENGTH=L -c $< -o $@
...
test_addition: test_addition.o ntt.o invntt.o consts.o rounding.o poly.o \
  polyveck_addition.o polyvecl_addition.o polyvecm_addition.o \
  comm_addition.o opening_addition.o product_addition.o linear_addition.o addition_addition.o \
  aes256ctr.o fips202.o randombytes.o cpucycles.o speed_print.o
	$(CC) $(CFLAGS) -DADDITION_PROOF $^ -o $@

test_mult: test_mult.o ntt.o invntt.o consts.o rounding.o poly.o \
  polyveck_mult.o polyvecl_mult.o polyvecm_mult.o \
  comm_mult.o opening_mult.o product_mult.o linear_mult.o apprshort_mult.o mult_mult.o \
  aes256ctr.o fips202.o randombytes.o cpucycles.o speed_print.o
